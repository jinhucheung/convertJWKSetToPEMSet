...
public class RSA {
    ...
    public static String encryptFromPublicKeyString(String rawText, String publicKeyString) throws IOException, GeneralSecurityException{
        RSAPublicKey publicKey = getPublicKeyFromString(publicKeyString);
        return RSA.encrypt(rawText, publicKey);
    }
}